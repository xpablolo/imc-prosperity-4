...
class _PepperTrader:
    ...
    INVENTORY_SKEW = 0.10
    SOFT_POSITION_LIMIT = 180
    HARD_POSITION_LIMIT = 280
    MAX_PASSIVE_SIZE = 22
    PASSIVE_REDUCTION_STEP = 8
    ...
    CARRY_MODE_SIGNAL = 1.40
    CARRY_MODE_IMBALANCE = 0.06
    CARRY_MODE_FLOW_FLOOR = -0.12
    CARRY_FLOOR_FRACTION = 0.65
    CARRY_OPPOSITE_SIZE_SCALE = 0.28
    CARRY_EXTRA_QUOTE_WIDEN = 1
    CARRY_SIZE_BONUS = 3

    BUDGET_MIN_UNITS = 60
    BUDGET_MAX_UNITS = 220
    BUDGET_BASE_RISK = 950.0
    BUDGET_TREND_BONUS = 1.15
    BUDGET_ADVERSE_VOL = 1.35
    BUDGET_ADVERSE_RESID = 1.65
    BUDGET_ADVERSE_SPREAD = 0.12

    WAREHOUSE_MODE_SIGNAL = 2.25
    WAREHOUSE_MODE_IMBALANCE = 0.10
    WAREHOUSE_MODE_FLOW = -0.08
    WAREHOUSE_TARGET_FRACTION = 0.55
    WAREHOUSE_FLOOR_FRACTION = 0.72
    WAREHOUSE_THRESHOLD_SHIFT = 1
    WAREHOUSE_SIZE_BONUS = 3
    WAREHOUSE_OPPOSITE_SCALE = 0.25
