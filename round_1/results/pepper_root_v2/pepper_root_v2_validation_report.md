# pepper_root_v2 — Validation Report
...
## Validation Snapshot
- Deterministic backtest total PnL: **126,834.5**
- Deterministic max drawdown: **-1,008.0**
- Replay total PnL: **113,972.0**
- Monte Carlo mean PnL: **89,995.5**
- Monte Carlo p05–p95: **76,769.4 → 102,925.4**
- Monte Carlo win rate: **100.0%**
- Monte Carlo mean sharpe-like: **4.84**
- Monte Carlo mean maker share: **24.8%**
...
- Bloque: 75 ticks
- Sesiones: 24
- Carpeta fuente: `/Users/pablo/Desktop/prosperity/round_1/results/montecarlo/pepper_root_v2/20260414_192234`
